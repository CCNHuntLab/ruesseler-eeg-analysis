...
if jumpRegressor
    cfg.clusteralpha = 0.085; % this is just for thresholding - equivalent to T>1.8 - using a lenient threshold as high-freq. noise means clusters often discontinuous when they should be clustered.
else
    clf.clusteralpha = 0.05; 
end
